...
```{r}
library(rio)
datakurs<-import("https://raw.githubusercontent.com/Safwa40/MPDW/main/Data/Data1.csv",header=T)
datakurs<-datakurs$`Batubara(USD/ton)`
